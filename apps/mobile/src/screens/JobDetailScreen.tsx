...
const styles = StyleSheet.create({
  ...
  title: { fontSize: typography.size.xl, fontWeight: typography.weight.bold as any, color: colors.ink, marginTop: spacing.xs },
  ...
  factValue: { fontSize: typography.size.md, fontWeight: typography.weight.semibold as any, color: colors.ink, flexShrink: 1 },
  factSub: { fontSize: typography.size.xs, color: colors.muted, fontWeight: typography.weight.regular as any },
  card: { gap: spacing.sm },
  gap: { height: spacing.md },
  evLabel: { fontSize: typography.size.base, fontWeight: typography.weight.semibold as any, color: colors.ink },
  ...
  condState: { fontSize: typography.size.xs, fontWeight: typography.weight.semibold as any },
