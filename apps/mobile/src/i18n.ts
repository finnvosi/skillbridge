...
const km: Dict = {
  ...
  'job.noChecksListed': 'មិនមានអ្វីដែលបានផ្ទៀងផ្ទាត់ត្រូវបានរាយទេ។',
  'job.cannotGuaranteeEmpty': 'យើងមិនអាចធានាអត្តិបត្តិរបស់ថៅកែបានទេ។',
  'job.noSkillsListed': 'មិនមានជំនាញដែលផ្គូផ្គងទេ។',
  'passport.noWorkRecords': 'មិនទាន់មានកំណត់ត្រាការងារដែលផ្ទៀងផ្ទាត់។',
  'passport.noSkills': 'មិនទាន់មានជំនាញត្រូវបានកត់ត្រា។',
  'passport.noLanguages': 'មិនទាន់មានភាសាត្រូវបានកត់ត្រា។',
  'passport.noSafety': 'មិនទាន់មានវិញ្ញាបនបត្រសុវត្ថិភាពត្រូវបានកត់ត្រា។',
  'passport.identityNotVerified': 'អត្តសញ្ញាណមិនបានផ្ទៀងផ្ទាត់',
...
const en: Dict = {
  ...
  'job.noChecksListed': 'No verification checks are listed yet.',
  'job.cannotGuaranteeEmpty': "We can't guarantee employer conduct — only what we verify.",
  'job.noSkillsListed': 'No matching skills listed yet.',
  'job.cannotGuaranteeHeader': "What SkillBridge cannot guarantee",
  'passport.noWorkRecords': 'No verified work records yet.',
  'passport.noSkills': 'No skills recorded yet.',
  'passport.noLanguages': 'No languages recorded yet.',
  'passport.noSafety': 'No safety qualifications recorded yet.',
  'passport.identityNotVerified': 'Identity not verified',
