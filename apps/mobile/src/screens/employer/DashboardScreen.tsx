...
const styles = StyleSheet.create({
  ...
  funnelValue: { fontSize: typography.size.sm, fontWeight: typography.weight.semibold as any, color: colors.textPrimary },
  ...
  acceptanceValue: { fontSize: typography.size.sm, fontWeight: typography.weight.semibold as any, color: colors.textPrimary },
  ...
  candidateInitials: { fontSize: 13, fontWeight: typography.weight.bold as any, color: colors.background },
  candidateInfo: { flex: 1, minWidth: 0 },
  candidateName: { fontSize: typography.size.base, fontWeight: typography.weight.semibold as any, color: colors.textPrimary },
