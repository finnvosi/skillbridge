-- Remote-safe certificate verification schema repair.
DO $$
BEGIN
  IF NOT EXISTS (
...
ALTER TABLE "Certificate" ADD COLUMN IF NOT EXISTS "verificationNote" TEXT;
...
ALTER TABLE "Certificate"
  ...
  USING CASE
    ...
    ELSE CASE WHEN "verified" = TRUE THEN 'verified' ELSE 'pending' END::"CertificateVerificationStatus"
  END;
