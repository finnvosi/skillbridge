...
const styles = StyleSheet.create({
  ...
  stepLabelDone: { color: colors.ink, fontWeight: typography.weight.semibold },
  ...
  viewLabel: { fontSize: typography.size.base, fontWeight: typography.weight.semibold, color: colors.primary },
});
